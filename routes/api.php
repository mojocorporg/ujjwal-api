...
Route::get('package',                                 [PaymentController::class, 'index'])->middleware('auth:sanctum');
Route::post('order',                                  [PaymentController::class, 'order'])->middleware('auth:sanctum');
Route::post('verify/payment',                         [PaymentController::class, 'verify_payment'])->middleware('auth:sanctum');
