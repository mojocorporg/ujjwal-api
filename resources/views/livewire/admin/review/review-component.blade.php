                                ...
                                <form wire:submit.prevent="store">
                                    <div class="card-body animated fadeIn delay-1s">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <br>
                                            <input type="checkbox" wire:model="review.status" name="status"
                                    ...
                                    <tbody>
                                        @foreach ($reviews as $review)
                                            <tr>
                                                ...
                                                @endif
                                                <td>
                                                    <a wire:click="edit({{ $review }})"
                                                        class="btn btn-sm btn-flat btn-primary"><i class="fa fa-eye"
                                                            aria-hidden="true"></i></a>
                                                    <a wire:click.prevent="destroy({{ $review->id }})"
                                                        onclick="confirm('Are you sure want to delete this review?') || event.stopImmediatePropagation()"
